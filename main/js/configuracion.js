...
const setupSupportUsButton = () => {
  ...
  if (donateButton) {
    donateButton.addEventListener("click", () => {
      window.location.href = "https://yamilatintern.blogspot.com/p/donaciones.html"; // Specific URL for donations
      if (supportModal) supportModal.classList.add("hidden");
    });
  }
  ...
  if (watchAdsButton) {
    watchAdsButton.addEventListener("click", () => {
      window.location.href = "https://yamilatintern.blogspot.com/p/anuncios.html"; // Specific URL for watching ads
      if (supportModal) supportModal.classList.add("hidden");
    });
  }
};
