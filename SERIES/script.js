// DOM Elements
        ...
        const generateFinalHTML = (mediaId, season, episode, episodesJson, theme) => {
            return `
<!DOCTYPE html>
<html lang="es">
<head>
...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@main/tv-series-app_/style.css" />
</head>
<body class="bg-gray-900 text-white" data-default-theme="${theme}">
  <div id="fb-root"></div>
  <script>
    window.fbAsyncInit = function() {
      FB.init({
        appId: "1320266426121861",
        xfml: true,
        version: "v18.0"
      });
  ...
  <div id="local-media-data" data-media-type="tv" data-media-id="${mediaId}" data-season-number="${season}" data-episode-number="${episode}" data-episode-type="regular" class="hidden"></div>
  ...
  <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@main/tv-series-app_/main.js"><\\/script>
  <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@main/tv-series-app_/lazy-loader.js"><\\/script>
  <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/y4m1@main/tv-series-app_/script.js"><\\/script>
</body>
</html>
\`;
    document.open();
  ...
  <\/script>
        ...
        const handleGenerate = () => {
            ...
            const finalHTML = generateFinalHTML(mediaId, season, episode, episodesJson, theme);
        ...
        const handleLoadFromCode = async (content) => {
            ...
            if (jsonMatch && jsonMatch[1]) {
                try {
                    ...
                    const seriesId = Object.keys(data)[0];
                    if (seriesId && seriesId !== mediaIdInput.value) {
                         mediaIdInput.value = seriesId;
                         await handleFetchSeries();
                    }
