...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app/css/styles.css" media="all" />
    <link
  ...
  <body class="bg-gray-900 text-white">
    ...
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/script.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/home.js"></script>
    <script src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/series.js" defer></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/adultContent.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/configuracion.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/aboutAndDMCA.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/buscador.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/config.js"></script>
    <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/main-start-app./js/favoritos.js"></script>
