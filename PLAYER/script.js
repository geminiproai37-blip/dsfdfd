...
const buildConfigObjects = () => {
    ...
    contentConfig.backUrl = "https://www.google.com";
    ...
    const GOOGLE_API_KEY = "AIzaSyA7v5KhMnwDwoFSGda7q8jrk0lkPhBUtoo";
...
<html lang="es">
  <head>
    ...
    <\/script>
        ...
        <script type="module" src="https://cdn.jsdelivr.net/gh/geminiproai37-blip/dsfdfd@main/reproductor-app-yami/script.js" defer><\/script>
      </head>
     <body>
